...
ENV LOKI_ENDPOINT=http://20.72.253.146/loki/api/v1/push

# (opsional, future use)
ENV ALLOY_OTLP_GRPC_ENDPOINT=http://20.98.125.199:4317
ENV ALLOY_OTLP_HTTP_ENDPOINT=http://20.98.125.199:4318
